...
namespace System.Net.Http
{
    ...
    public static class HttpRequestMessageExtensions
    {
        ...
        {
            return request.CreateErrorResponse(statusCode, new HttpError(statusCode, null));
        }
        ...
        {
            return request.CreateErrorResponse(statusCode, includeErrorDetail => includeErrorDetail ? new HttpError(statusCode, null) : new HttpError(statusCode, null));
        }
        ...
        public static HttpResponseMessage CreateErrorResponse(this HttpRequestMessage request, HttpStatusCode statusCode, string message, Exception exception)
        {
            ...
            return request.CreateErrorResponse(statusCode, includeErrorDetail => new HttpError(statusCode, exception));
        }
        ...
        private static HttpResponseMessage CreateErrorResponse(this HttpRequestMessage request, HttpStatusCode statusCode, Func<bool, HttpError> errorCreator)
        {
            ...
            {
                var defaultConfig = new HttpConfiguration();
                {
                    HttpError error = errorCreator(false);
                    return request.CreateResponse<HttpError>(statusCode, error, defaultConfig);
                }
            }
            else
            {
                HttpError error = errorCreator(true);
        ...
        public static HttpResponseMessage CreateResponse<T>(this HttpRequestMessage request, HttpStatusCode statusCode, T value, HttpConfiguration configuration)
        {
            ...
            ContentNegotiationResult result = null; // contentNegotiator.Negotiate(typeof(T), request, formatters);
